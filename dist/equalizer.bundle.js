(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["equalizerjs"] = factory();
	else
		root["equalizerjs"] = factory();
})(this, function() {
...
var arrayFilter = __webpack_require__(362),
...
var arrayLikeKeys = __webpack_require__(145),
    baseKeys = __webpack_require__(377),
    isArrayLike = __webpack_require__(72);
...
var mapCacheClear = __webpack_require__(418),
    ...
    mapCacheGet = __webpack_require__(420),
    mapCacheHas = __webpack_require__(421),
    mapCacheSet = __webpack_require__(422);
...
var baseTimes = __webpack_require__(382),
...
var identity = __webpack_require__(161),
    overRest = __webpack_require__(428),
    setToString = __webpack_require__(431);
...
var baseIsTypedArray = __webpack_require__(376),
    baseUnary = __webpack_require__(383),
...
var _union2 = __webpack_require__(446);

var _union3 = _interopRequireDefault(_union2);

var _cloneDeep2 = __webpack_require__(439);

var _cloneDeep3 = _interopRequireDefault(_cloneDeep2);

var _merge2 = __webpack_require__(442);
...
var Equalizer = function () {
  _createClass(Equalizer, [{
     ...
     */
    value: function checkIfIEOrEdge() {
    ...
    key: 'initDefaultProps',
    value: function initDefaultProps() {
    ...
    value: function setProps(props) {
      typeof props !== 'undefined' ? this._props = (0, _merge3.default)((0, _cloneDeep3.default)(this._defaultProps), props) : this._props = this._defaultProps;
    }
    ...
    key: 'getThumbCoordinates',
    value: function getThumbCoordinates(idx) {
      var ar = this.getProps().aspectRatio;

      var containerBB = this.container.getBoundingClientRect();
      var thumbBB = this._thumbs[idx].getBoundingClientRect();

      var thumbCenter = thumbBB.left + thumbBB.width / 2;

      var x = (thumbCenter - containerBB.left) * 100 / containerBB.width * ar;
      var y = 100 - this._inputs[idx].value;
      return { x: x, y: y };
    }
    ...
    key: 'initInputsContainer',
    value: function initInputsContainer() {
    ...
    value: function createInputs() {
      ...
      try {
        for (var _iterator = this.getProps().values[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var value = _step.value;

          var node = this.createSingleInput();

          // checking that the value is a valid value
          var finalValue = value.defaultPosition >= 0 && value.defaultPosition <= 100 ? value.defaultPosition : 50;
    ...
    value: function createSingleInput() {
    ...
    value: function updateSlider() {
      ...
      var path = this.svgPath;
      // setting up starting point
      var d = "M {0},{1} L {2},{3} ".format(0, this.getProps().startingPointY, 0, this.getProps().startingPointY);

      // adding up a fake input to simulate the end point
      var inputs = (0, _union3.default)(this._inputs, [{ x: 100 * this.getProps().aspectRatio, y: this.getProps().endingPointY }]);

      // funny part, passing through the points, TODO: dynamic control points
      for (var idx in inputs) {
        var input = inputs[idx];
        var prevPoint = parseInt(idx) === 0 ? { x: 0, y: this.getProps().startingPointY } : this.getThumbCoordinates(idx - 1);
        var point = parseInt(idx) === inputs.length - 1 ? input : this.getThumbCoordinates(idx);
        var middlePoint = (point.x + prevPoint.x) / 2;
        // let's assume, for now, that the control points are simply half way and straight
        var curve = "C {0},{1} {2},{3} {4},{5} ".format(middlePoint, prevPoint.y, middlePoint, point.y, point.x, point.y);
        d += curve;
      }
    ...
    value: function updateThumbPosition(input) {
      // updating Thumb position logic
      var thumb = input.parentElement.querySelector('.' + this.getProps().cssPrefix + this.getProps().rangeSlidersClass + '-thumb');
      var label = input.parentElement.querySelector('.' + this.getProps().cssPrefix + this.getProps().rangeSlidersClass + '-label');
    ...
    key: 'clearElementDOM',
    value: function clearElementDOM() {
    ...
    value: function animateCurveToPositionAndAbilitateThumbs() {
      var _this = this;

      // TODO: documentate this parameter
      var duration = this.getProps().animationDuration;
      // animating for the first time
      var tl = new TimelineLite({
        paused: true,
        onComplete: function onComplete() {
          // setting up events for thumbs
          _this.initThumbsEvents();
        },
    ...
    key: 'resizeEqualizer',
    value: function resizeEqualizer() {
    ...
    key: 'initThumbsEvents',
    value: function initThumbsEvents() {
    ...
    value: function inputChangeCallback(e) {
      var input = e.target;
      if (typeof input !== 'undefined') {
        ...
        var inputChangedEvent = new CustomEvent('equalizer-change', {
          detail: {
            'input': input
          }
        });
    ...
    value: function drawGradient() {
      var linearGradient = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;

      var lg = typeof linearGradient !== 'undefined' ? linearGradient : this.getProps().linearGradient;
      var NS = this._svgNS;

      // setting up the defs container and the linear gradient general stuff
      var defs = document.createElementNS(NS, 'defs');
      // linear gradient tag
      var linearGradientEl = document.createElementNS(NS, 'linearGradient');
      ...
      try {
        for (var _iterator4 = lg.stops[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    key: 'changeGradient',
    value: function changeGradient(stops) {
      var duration = this.getProps().animationDuration;
      var stopsElement = this.svg.querySelectorAll('defs linearGradient stop');
      ...
      try {
        for (var _iterator5 = stopsElement[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var stopElement = _step5.value;
...
var $export = __webpack_require__(0)
  , $reduce = __webpack_require__(117);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(173));
...
var $export     = __webpack_require__(0)
  , $parseFloat = __webpack_require__(133);
...
var $export      = __webpack_require__(0)
  , toInteger    = __webpack_require__(31)
  , aNumberValue = __webpack_require__(114)
  , repeat       = __webpack_require__(93)
  , $toFixed     = 1..toFixed
  , floor        = Math.floor
  , data         = [0, 0, 0, 0, 0, 0]
...
var Stack = __webpack_require__(144),
    arrayEach = __webpack_require__(361),
    ...
    copySymbols = __webpack_require__(391),
    copySymbolsIn = __webpack_require__(392),
    getAllKeys = __webpack_require__(397),
    getAllKeysIn = __webpack_require__(398),
    getTag = __webpack_require__(400),
    initCloneArray = __webpack_require__(407),
    initCloneByTag = __webpack_require__(408),
...
var baseFindIndex = __webpack_require__(369),
    baseIsNaN = __webpack_require__(374),
    strictIndexOf = __webpack_require__(438);
...
var isFunction = __webpack_require__(110),
    isMasked = __webpack_require__(412),
    isObject = __webpack_require__(32),
...
var isObject = __webpack_require__(32),
    isPrototype = __webpack_require__(106),
    nativeKeysIn = __webpack_require__(425);
...
var Stack = __webpack_require__(144),
    assignMergeValue = __webpack_require__(147),
    baseFor = __webpack_require__(371),
    baseMergeDeep = __webpack_require__(380),
    isObject = __webpack_require__(32),
    keysIn = __webpack_require__(73);
...
var assignMergeValue = __webpack_require__(147),
    cloneBuffer = __webpack_require__(151),
    ...
    isTypedArray = __webpack_require__(164),
    toPlainObject = __webpack_require__(445);
...
var SetCache = __webpack_require__(355),
    arrayIncludes = __webpack_require__(363),
...
var addMapEntry = __webpack_require__(358),
    arrayReduce = __webpack_require__(146),
...
var addSetEntry = __webpack_require__(359),
    arrayReduce = __webpack_require__(146),
    setToArray = __webpack_require__(107);
...
var baseRest = __webpack_require__(150),
    isIterateeCall = __webpack_require__(410);
...
var cloneArrayBuffer = __webpack_require__(103),
    ...
    cloneMap = __webpack_require__(387),
    cloneRegExp = __webpack_require__(388),
    cloneSet = __webpack_require__(389),
    cloneSymbol = __webpack_require__(390),
    cloneTypedArray = __webpack_require__(152);
...
var coreJsData = __webpack_require__(393);
...
var baseSetToString = __webpack_require__(381),
    shortOut = __webpack_require__(432);
...
var baseClone = __webpack_require__(367);
...
var baseMerge = __webpack_require__(379),
    createAssigner = __webpack_require__(394);
...
var baseFlatten = __webpack_require__(370),
    baseRest = __webpack_require__(150),
    baseUniq = __webpack_require__(384),
    isArrayLikeObject = __webpack_require__(162);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(112), __webpack_require__(447)))
