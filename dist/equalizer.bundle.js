...
var identity = __webpack_require__(50),
    overRest = __webpack_require__(129),
...
var _union2 = __webpack_require__(149);
...
var _merge2 = __webpack_require__(145);
...
var Equalizer = function () {
  _createClass(Equalizer, [{
    ...
    value: function animateCurveToPositionAndAbilitateThumbs() {
      ...
      var tl = new TimelineLite({
        ...
        onComplete: function onComplete() {
          ...
          _this.element.parentNode.classList.remove('locked');
    ...
    key: 'animateCurveToPosition',
    value: function animateCurveToPosition() {
      var _this2 = this;
      ...
      var tl = new TimelineLite({
        ...
        onComplete: function onComplete() {
          // unlocking the element
          _this2.element.parentNode.classList.remove('locked');
          // triggering a last update
          _this2.updateSlider();
          _this2.element.dispatchEvent(new CustomEvent('animated-to-position'));
        },
        onUpdate: function onUpdate() {
          _this2.updateSlider();
        }
      ...
      for (var inputIndex in this._inputs) {
        // if the array of values is partial, break
        if (typeof values[inputIndex] === 'undefined') {
          break;
        }

        var input = this._inputs[inputIndex];

        var thumb = input.parentElement.querySelector('.' + this.getProps().cssPrefix + this.getProps().rangeSlidersClass + '-thumb');
        var label = input.parentElement.querySelector('.' + this.getProps().cssPrefix + this.getProps().rangeSlidersClass + '-label');
        var value = input.value;
        var newValue = values[inputIndex];
    ...
    key: 'changeCurveOpacity',
    value: function changeCurveOpacity(opacity) {
      var duration = this.getProps().animationDuration;
      var stopsElement = this.svg.querySelectorAll('defs linearGradient stop');
      ...
      try {
        for (var _iterator6 = stopsElement[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          var stopElement = _step6.value;
...
var Stack = __webpack_require__(32),
    ...
    baseAssignIn = __webpack_require__(71),
    cloneBuffer = __webpack_require__(38),
    ...
    isArray = __webpack_require__(6),
    isBuffer = __webpack_require__(26),
    isMap = __webpack_require__(142),
    isObject = __webpack_require__(1),
    isSet = __webpack_require__(144),
    keys = __webpack_require__(28);
...
var baseFindIndex = __webpack_require__(74),
    baseIsNaN = __webpack_require__(80),
...
var Stack = __webpack_require__(32),
    ...
    baseMergeDeep = __webpack_require__(87),
    isObject = __webpack_require__(1),
    keysIn = __webpack_require__(14),
    safeGet = __webpack_require__(47);
...
var assignMergeValue = __webpack_require__(34),
    cloneBuffer = __webpack_require__(38),
    cloneTypedArray = __webpack_require__(39),
    copyArray = __webpack_require__(40),
    initCloneObject = __webpack_require__(44),
    isArguments = __webpack_require__(25),
    isArray = __webpack_require__(6),
...
var SetCache = __webpack_require__(62),
    ...
    arrayIncludesWith = __webpack_require__(69),
    cacheHas = __webpack_require__(91),
    createSet = __webpack_require__(100),
...
var cloneArrayBuffer = __webpack_require__(19),
    ...
    cloneRegExp = __webpack_require__(93),
...
var baseIsMap = __webpack_require__(79),
    baseUnary = __webpack_require__(18),
    nodeUtil = __webpack_require__(24);
...
var baseIsSet = __webpack_require__(82),
    baseUnary = __webpack_require__(18),
    nodeUtil = __webpack_require__(24);
